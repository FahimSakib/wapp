...
<section id="page-banner" class="pt-105 pb-130 bg_cover" data-overlay="8"
    style="background-image: url(asset/frontend/images/page-banner-4.jpg)">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="singel-blog mt-30">
                    <div class="blog-thum">
                        <img src="asset/frontend/images/blog/b-1.jpg" alt="Blog">
                    </div>
                    <div class="blog-cont">
                ...
                <div class="singel-blog mt-30">
                    <div class="blog-thum">
                        <img src="asset/frontend/images/blog/b-2.jpg" alt="Blog">
                    </div>
                    <div class="blog-cont">
                        <a href="blog-singel.html">
                            <h3>Few tips for get better results in examination</h3>
                                ...
                                <ul>
                                    <li>
                                        <a href="#">
                                            <div class="singel-post">
                                                <div class="thum">
                                                    <img src="asset/frontend/images/blog/blog-post/bp-1.jpg" alt="Blog">
                                                </div>
                                                <div class="cont">
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="singel-post">
                                                <div class="thum">
                                                    <img src="asset/frontend/images/blog/blog-post/bp-2.jpg" alt="Blog">
                                                </div>
                                                <div class="cont">
